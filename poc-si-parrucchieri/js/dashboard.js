// Durata: LEGATO-A:P03
/* ============================================================
   SI Parrucchieri — dashboard del salone
...
function renderLista(listaTutta) {
  ...
  lista.forEach((p) => {
    ...
    const pillPag = p.pagamento === "caparra"
      ...
      : `<span class="pill pill-grigia">Paga in salone</span>`;
    ...
    card.innerHTML = `
      <div class="pren-head">
        ...
        <div class="pren-chi">
          ...
          <span>${p.servizioNome} · ${minutiATesto(p.durata)} · ${p.prezzoDa ? "da " : ""}${euro(p.prezzo)}</span>
        </div>
      ...
      <div class="pren-body">
        ...
        ${p.foto && p.foto.length ? `
          <h4>Foto di ispirazione (private)</h4>
          <div class="pren-foto">${p.foto.map((f) => `<img src="${f}" alt="Foto di ispirazione" />`).join("")}</div>` : ""}
        <h4>Contatti</h4>
...
/* ---------- Prenotazioni di esempio (per la demo al titolare) ---------- */

document.getElementById("btn-demo").addEventListener("click", () => {
  const esempi = [
    {
      servizioId: "col-erbe", nome: "Francesca", cognome: "Colombo", tel: "348 2214761",
      ora: "10:00", giorniAvanti: 1, pagamento: "caparra", origine: "instagram",
      risposte: { base: "Castano scuro", storia: "Sì, hennè o erbe tintorie", direzione: "Restare sul mio tono", effetto: "Colore pieno", note: "Cute sensibile, preferisco prodotti naturali" },
    },
    {
      servizioId: "taglio-lui", nome: "Marco", cognome: "Rovelli", tel: "339 5561208",
      ora: "17:30", giorniAvanti: 1, pagamento: "salone", origine: "sito",
      risposte: { lunghezza: "Corto", sfumatura: "Sì, bassa", barba: "Sì" },
    },
    {
      servizioId: "taglio-lei", nome: "Elena", cognome: "Bonfanti", tel: "351 8837194",
      ora: "15:00", giorniAvanti: 3, pagamento: "caparra", origine: "instagram",
      risposte: { lunghezza: "Lunghi", cambio: "Un cambio deciso", frangia: "Da valutare insieme", note: "Matrimonio di mia sorella il mese prossimo!" },
    },
  ];
