...
(function () {
  ...
  // ---------- Chip selezionabili (servizio richiesto, multi-selezione) ----------
  var chipsServizio = document.getElementById("chipsServizio");
  if (chipsServizio) {
    chipsServizio.querySelectorAll(".chip").forEach(function (chip) {
